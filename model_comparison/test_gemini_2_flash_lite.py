...
def main():
    ...
    parser = argparse.ArgumentParser(description='Test Gemini 2.0 Flash-Lite model for ASL recognition')
    ...
    results_file = f"flash_lite_{args.prompt_strategy}_result_{timestamp}.json"

...
def get_asl_prediction(image_path: str, model_type: Literal["flash", "flash-lite"] = "flash", 
                      prompt_strategy: Literal["zero_shot", "few_shot", "chain_of_thought"] = "zero_shot") -> dict:
